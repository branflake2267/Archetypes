...
import ${package}.client.application.east.EastPresenter;
import ${package}.client.application.north.NorthPresenter;
import ${package}.client.application.west.WestPresenter;
